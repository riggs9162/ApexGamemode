...
--Set true to enable | false to disable.
blockfamilysharing = true

--The message to display to those who have been blocked by "blockfamilysharing".
blockfamilysharingmessage = "Sorry, we no longer allow account that don't own the game fully. For more information goto support.apex-roleplay.com"

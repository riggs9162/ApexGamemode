...
/*AddEntity("Microwave", {
	...
	max = 1,
	cmd = "/buymicrowave",
	customCheck = function(ply) if ply:Team() == TEAM_CP and CPMenuPlyTable and CPMenuPlyTable[ply:SteamID64()] and CPMenuPlyTable[ply:SteamID64()]["Division"] == 2 then return true else return false end end
})*/
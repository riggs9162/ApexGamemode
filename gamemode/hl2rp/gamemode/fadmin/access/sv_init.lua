...
hook.Add("PlayerInitialSpawn", "FAdmin_SetAccess", function(ply)
	MySQL.queryValue("SELECT groupname FROM FAdmin_PlayerGroup WHERE steamid = " .. MySQL.SQLStr(ply:SteamID())..";", function(Group)
	...
	--timer.Simple( 5, function() hook.Call("slotsStuff", nil, ply) end )

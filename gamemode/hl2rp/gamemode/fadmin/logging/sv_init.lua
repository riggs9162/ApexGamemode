...
hook.Add("CanTool", "FAdmin_Log", function(ply, tr, toolclass) FAdmin.Log(ply:Nick().." ("..ply:SteamID()..") Attempted to use tool "..toolclass)
	FAdmin.Log(ply:Nick().." ("..ply:SteamID()..") used the tool: "..toolclass, nil, Color(0, 255, 255))
	end)
